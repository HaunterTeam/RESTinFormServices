 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.document/", wsdlLocation = "http://localhost:8443/dbservice/ws/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8443/dbservice/ws/people?wsdl");
